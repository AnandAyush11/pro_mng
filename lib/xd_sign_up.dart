            ...
            child:
              ...
              children: <Widget>[
                ...
                Pinned.fromPins(
                  ...
                  child:
                      // Adobe XD layer: 'ForgotBtn' (group)
                      PageLink(
                    links: [
                      PageLinkInfo(
                        duration: NaN,
                ...
                Pinned.fromPins(
                  Pin(start: 10.0, end: 15.0),
                  Pin(size: 64.0, middle: 0.2912),
                  child:
